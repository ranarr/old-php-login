<?php
  ...
  $dbpassword = "password";
   if(isset($_POST['sub'])){
       ...
       if($email != $dbemail){ echo"UNKNOWN EMAIL";}
       if($password != $dbpassword){ echo"UNKNOWN PASSWORD";}
   }
...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Midterm</title>
      <style type="text/css"> /* all of skeleton css */
      ...
      <form name='input' action='home.php' method='post'>
         <div class="container">
            <section class="header">
               <img src="headimage.gif">
               </br>
            </section>
            <div class="row">
               <div class="six columns">
                  <input class="u-full-width" name="email" type="email" placeholder="email" id="email">
               </div>
               <div class="six columns">
                  <input class="u-full-width" name="password" type="password" placeholder="password" id="password">
               </div>
               <input class="button-primary" type="submit" name="sub" value="Submit" >
            </div>
      </form>
      </div>
